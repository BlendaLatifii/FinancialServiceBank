...
function Services() {
  return (
    ...
    <Header/>
<main>
  <div className="p-3 mb-2 bg-dark text-white" style={{borderTopLeftRadius: '20px', borderTopRightRadius: '20px' }}>
    <br/>
    <div className="justify-content-start ms-1">
      <div className="text-center">
        <div className="text-wrap" style={{ width: '8rem', fontSize: '15px', backgroundColor: 'rgba(251, 255, 0, 0.2)', color: 'rgb(236, 253, 0)', borderRadius: '20px', padding: '10px' }}>
        New Service
        </div>
      </div>
      <br/>
      ...
      <div className="text-wrap d-flex justify-content-start">
        <div>
          ...
          <p className="fw-lighter" style={{ color: 'rgb(117, 118, 119)', maxWidth: '30rem' }}>In addition to smart chipsets, the new e-WFB credit cards are also connected directly to Wi-fi and smart devices for doing banking and managing them.</p>
        </div>
      </div>
      <div style={{ marginTop: '20px' }}>
        <button type="button" className="btn btn-lg" style={{ background: 'linear-gradient(to top right, white 0%, #ffcc00 100%)', fontSize: '15px', marginRight: '10px' }}>
    ...
    <div className="d-flex justify-content-center">
      <div className="card text-bg-dark mb-3 text-center" style={{width: '18rem', marginRight: '30px'}}>
        <br/>
      ...
      <div className="card text-bg-dark mb-3 text-center" style={{width: '18rem', marginRight: '30px'}}>
        ...
        <div className="card-body">
          <p className="card-text text-position">GoldCard is a major innovation in the field of financial services around the world, bringing a new and advanced experience for its users.</p>
          <a href="#" className="btn btn-success">Apply</a>
        </div>
      </div>
      <div className="card text-bg-dark mb-3 text-center" style={{width: '18rem'}}>
        <br/>
