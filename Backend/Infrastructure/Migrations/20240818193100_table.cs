        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TypesOfCreditCards_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClientBankAccounts_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClientBankAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoansTypesId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientBankAccounts_AccountNumberGeneratedID",
                table: "ClientBankAccounts",
                column: "AccountNumberGeneratedID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClientBankAccounts_BankAccountId",
                table: "ClientBankAccounts",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientBankAccounts_BranchId",
                table: "ClientBankAccounts",
                column: "BranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypesOfCreditCards_UserId",
                table: "TypesOfCreditCards",
                column: "UserId");
        }
